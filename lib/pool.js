...
// The Sumo address prefixes and lengths used for verification.
var sumoWalletBase58AddressPrefix = '2864026';
var sumoWalletBaseAddressLength = 99;
var sumoWalletBase58SubAddressPrefix = '536986';
var sumoWalletBaseSubAddressLength = 98;
...
function handleMinerMethod(method, params, ip, portData, sendReply, pushMessage){
    ...
    switch(method){
        case 'login':
            ...
            if (addressPrefix == sumoWalletBase58AddressPrefix && login.length != sumoWalletBaseAddressLength){
                sendReply('invalid address used: malformed wallet address');
                return;
            } else if (addressPrefix == sumoWalletBase58SubAddressPrefix && login.length != sumoWalletBaseSubAddressLength) {
                sendReply('invalid address used: malformed subaddress');
                return;
            } else {
